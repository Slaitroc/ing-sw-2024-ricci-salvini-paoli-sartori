...
// public class OldTUI extends UI {
...
// public OldTUI(ClientCommands client) {
...
// System.out.println(DefaultValues.ANSI_BLUE + DefaultValues.TUI_TAG +
// DefaultValues.ANSI_RESET + text);
// }

// private void tuiWriteGreen(String text) {
// System.out.println(DefaultValues.ANSI_BLUE + DefaultValues.TUI_TAG +
// DefaultValues.ANSI_GREEN + text
// + DefaultValues.ANSI_RESET);
// }

// private void tuiWritePurple(String text) {
// System.out.println(DefaultValues.ANSI_BLUE + DefaultValues.TUI_TAG +
// DefaultValues.ANSI_PURPLE + text
// + DefaultValues.ANSI_RESET);
// }

// /**
// * Initializes all the commands info maps adding the right description for
// each
// * command
// *
// * @Slaitroc
...
// /* TUI implementation */
// /**
// * Runs the corresponding Runnable value to the String key in the active
// command
// * map
// *
