...
/**
 * This class represents the action of flipping the {@link it.polimi.ingsw.gc31.model.card.StarterCard}.
 */
public class FlipStarterCardObj extends ServerQueueObject {
    /**
     * Is the username of the player that wants to flip the {@link it.polimi.ingsw.gc31.model.card.StarterCard}.
     */
     ...
     *
     * @param username is the username of the client that wants to flip the {@link it.polimi.ingsw.gc31.model.card.StarterCard}.
     */
    public FlipStarterCardObj(String username) {
        this.username = username;
    }

    /**
     * This method is executed by the {@link GameController} when it is polled from the queue.
     * Invokes the {@link GameController#changeStarterSide(String)}.
     *
