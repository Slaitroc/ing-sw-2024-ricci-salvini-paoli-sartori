...
/**
 * This abstract class defines an observable for various aspects of a player's
 * attributes.
...
public abstract class PlayerObservable {
    ...
    // Observable<LinkedHashMap<String, Integer>> playerScoreListeners = new
    // Observable<>();
    ...
    // */
    // public void addPlayerScoreListener(Listener<LinkedHashMap<String, Integer>>
    // listener) {
     ...
     */
    public void addPlayAreaListener(
            Listener<Pair<String, Pair<Map<Point, PlayableCard>, Map<Resources, Integer>>>> listener) {
    ...
    // */
    // public void removePlayerHandListener(Listener<Pair<String,
    // List<PlayableCard>>> listener) {
    ...
    // * @param listener the listener to be removed.
    // */
    // public void removePlayerObjectiveCardListener(Listener<ObjectiveCard>
    // listener) {
    ...
    // * @param listener the listener to be removed.
    // */
    // public void removePlayerScoreListener(Listener<Pair<String, Integer>>
    // listener) {
    ...
    // * @param listener the listener to be removed.
    // */
    // public void removePlayAreaListener(Listener<Pair<String, Pair<Map<Point,
    // PlayableCard>, Map<Resources, Integer>>>> listener) {
    // playAreaListeners.removeListener(listener);
    // }
    //
    // public void
    // removePlayerChooseObjectiveCardListener(Listener<Pair<ObjectiveCard,
    // ObjectiveCard>> listener) {
     ...
     *
     * @param data a Pair<String, List<PlayableCard>> object containing the player's
     *             name and updated hand.
     */
    ...
    /**
     * Notifies all registered listeners about an update to the player's starter
     * card.
     *
     * @param data a Pair<String, List<PlayableCard>> object containing the player's
     *             starter card.
    ...
    /**
     * Notifies all registered listeners about an update to the player's objective
     * card.
     *
     * @param data a Pair<String, List<PlayableCard>> object containing the player's
     *             objective card.
    ...
    // *
    // * @param data a Pair<String, List<PlayableCard>> object containing the
    // player's score.
    // */
