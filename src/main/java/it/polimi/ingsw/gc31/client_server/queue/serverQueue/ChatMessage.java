...
public class ChatMessage extends ServerQueueObject {
    ...
    /**
     * Is the username of the player that should receive the message (private message).
     */
     ...
     * @param toUsername    is the username of the player that should receive the message.
