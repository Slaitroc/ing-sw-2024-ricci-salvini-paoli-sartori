...
public interface ClientCommands {
     ...
     * hand.
     *
     * @param index index=0 to draw from top of the deck. index=1,2 to draw card1,card2
     * @throws RemoteException if a generic connection error occurs
     */
    ...
    /**
     * Change side of the current selected card in hand (Notice: True=Front, False=Back)
     * @throws RemoteException if a generic connection error occurs
     */
