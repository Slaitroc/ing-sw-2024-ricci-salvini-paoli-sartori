 ...
 * Listeners are used to retrieve updates from the game model and send them to
 * clients.
 * The listeners are organized based on different listener types.
 * Use the methods provided to enable/disable listeners, add/remove listeners,
 * and notify listeners.
 */
public class GameListenerHandler {
    /**
     * Map that stores the different types of listeners used in the
     * GameListenerHandler class.
     * The map is organized based on the ListenerType enum as the key and the
     * corresponding Listener object as the value.
     */
    ...
    /**
     * This class represents a boolean variable that indicates whether a listener is
     * enabled or disabled.
     * A listener is enabled when it is able to send updates, and disabled when it
     * is not.
    ...
    /**
     * Notifies all the listeners with the given GameModel object only if enabled is
     * set true.
     *
     * @param model The GameModel object containing the updates to be sent to the
     *              listeners.
     */
    ...
    /**
     * Notifies the listener of the specified type with the given GameModel object
     * only if enabled is set true.
     *
