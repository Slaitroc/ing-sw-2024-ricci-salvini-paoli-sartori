 ...
 * It implements the {@link VirtualClient} interface to allow the rmi server to
 * call methods on the client via the RMI communication protocol.
 * It implements also the {@link ClientCommands} interface which defines the
 * methods that can be called from the tui on the client-side rmiClient.
 */
public class RmiClient extends UnicastRemoteObject implements VirtualClient, ClientCommands {
     ...
     * It is used to send commands from the client to the {@link IController} on the
     * server using the rmi communication protocol.
     */
    private IController controller;

    /**
     * This private variable represents an instance of the interface VirtualServer.
     * It is used to send commands from the client to the {@link RmiServer} on the
     * server using the rmi communication protocol.
     */
    private final VirtualServer server;

    /**
     * This private variable represents an instance of the interface
     * IGameController.
     * It is used to send commands from the client to the
     * {@link it.polimi.ingsw.gc31.controller.GameController} on the server using
     * the rmi communication protocol.
     */
     ...
     * The first connection with the server occurs and the reference to the
     * virtualServer is saved in the server variable
     * e notifies the server of the first connection.
     * The tempToken generated by the server is saved which allows the server to
     * identify this client until the username is set.
     * The executor thread is started.
     *
     * @param ipaddress the IP address of the server to connect to
     * @throws RemoteException   if a remote error occurs
     * @throws NotBoundException if the specified name is not currently bound in the
     *                           registry
     */
    ...
    /**
     * Method of the {@link ClientCommands} that sends the object to the server for
    ...
    /**
     * Method of the {@link ClientCommands} that send an object to the controller of
     * the type {@link CreateGameObj}
     * that tells the server to create a new game with a specified maximum number of
     * players.
     *
    ...
    /**
     * Method of the {@link ClientCommands} that send an object to the controller of
     * the type {@link JoinGameObj} that ask the server to join the game with the
     * specified game id.
     *
    ...
    /**
     * Method of the {@link ClientCommands} that send an object to the
     ...
     *              If a value other than these three an object of the type
     ...
     *
     * @param point The coordinates of the point where the player wants to play the
     *              selected card.
     * @throws RemoteException If there is an error in the remote communication
     */
     ...
     *              The accepted indexes are 0,1,2, other indexes cause the server
     *              to send an object of the type
     *              {@link it.polimi.ingsw.gc31.client_server.queue.clientQueue.ShowInvalidActionObj}
     *              is sent by the server.
     * @throws RemoteException if there is an error in the remote communication
     */
     ...
     * {@link it.polimi.ingsw.gc31.controller.GameController} of the type
     * {@link FlipCardObj}
     * that tells the server the player wants to change the side of the selected
     * card of the hand.
     *
     ...
     * Method of the {@link ClientCommands} that send an object to the
     * {@link it.polimi.ingsw.gc31.controller.GameController} of the type
     * {@link FlipStarterCardObj}
     * that tells the server the player wants to change the side of the starter
     * card.
     *
     * @throws RemoteException if a remote exception occurs during the method call.
     */
    ...
    /**
     * Method of the {@link ClientCommands} that returns the ID of the game the
    ...
    /**
     * Method of the {@link ClientCommands} that returns the username associated
     * with this user.
     *
    ...
    /**
     * Method of the {@link ClientCommands} that sets the {@code token} for
     * authentication.
     * If the token to be set is permanent write the token in a file.
     * If the token is temporary then save it in a file.
     * It is saved in a file to allow the player to reconnect to the game he was
     * playing in case of disconnection
     *
     * @param token     the token value to be set
     * @param temporary if true, sets temporary token; otherwise, sets permanent
     *                  token
     */
    @Override //
     ...
     * Method of the {@link ClientCommands} that sends an object to the
     * {@link it.polimi.ingsw.gc31.controller.GameController} of the type
     * {@link ReconnectObj} that
     * tells the server if the player wants to rejoin the game which he previously
     * disconnected from.
     *
     * @param reconnect true to rejoin to the game which the player previously
     *                  disconnected from , false to not rejoin.
    ...
    /**
     * Method of the {@link VirtualClient} that return the ready status of the
     * player.
     *
    ...
    /**
     * Method of the {@link VirtualClient} that is called by the server to send an
     * object of type {@link ClientQueueObject}.
     *
    ...
    /**
     * Method of the {@link VirtualClient} that is called by the server to set
     * {@code controller} with
    ...
    // @Override
    // public void anotherMatchResponse(Boolean wantsToRematch) throws
    // RemoteException {
    // gameController.sendCommand(new AnotherMatchResponseObj(username,
    // wantsToRematch));
    // }
    //
    // @Override
