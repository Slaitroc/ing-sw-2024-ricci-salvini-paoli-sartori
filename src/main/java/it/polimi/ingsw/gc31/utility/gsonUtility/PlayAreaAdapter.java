...
public class PlayAreaAdapter implements JsonSerializer<Map<Point, PlayableCard>>, JsonDeserializer<Map<Point, PlayableCard>> {
    @Override
    public JsonElement serialize(Map<Point, PlayableCard> pointPlayableCardMap, Type type, JsonSerializationContext jsonSerializationContext) {
    ...
    @Override
    public Map<Point, PlayableCard> deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext jsonDeserializationContext) throws JsonParseException {
