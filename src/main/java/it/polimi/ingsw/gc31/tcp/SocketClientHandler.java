...
public class SocketClientHandler implements VirtualClient {
    ...
    // This method executes the functions of the controller based on what input it
    // receives. Also need to call the server
    // in order to send updates to all other clients
    public void runVirtualClient() throws IOException, PlayerNicknameAlreadyExistsException {
        String line;
