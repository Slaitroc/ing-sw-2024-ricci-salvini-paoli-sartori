...
public class SocketClientHandler implements VirtualView{
    ...
    public SocketClientHandler(VirtualController controller, SocketServer server, BufferedReader input, PrintWriter output, Integer progressiveIdGame) throws RemoteException {
        ...
        while((line = input.readLine()) != null){
            ...
            switch(line) {
                case "connect" : {
                    ...
                    sendMsg("[ SERVER ] Connected. Possible commands: [ crea game, mostra game, join game ]");
                    break;
                }
                case "crea game" : {
