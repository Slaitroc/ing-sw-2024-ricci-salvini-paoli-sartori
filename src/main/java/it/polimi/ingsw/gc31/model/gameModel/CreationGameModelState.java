...
public class CreationGameModelState implements GameModelState {
    ...
    public Map<String, Player> initGame(GameModel model, LinkedHashMap<String, VirtualClient> clients)
        ...
        createAllListeners(model, clients.values().stream().toList());
    ...
    private void createAllListeners(GameModel model, List<VirtualClient> clients) {
        model.addPlayAreaListener(new PlayAreaListener(clients));
        model.addHandListener(new PlayerHandListener(clients));
        model.addChooseObjectiveListener(new PlayerChooseObjectiveCardListener(clients));
        model.addStarterCardListener(new PlayerStarterCardListener(clients));
        model.addTurnListener(new PlayerTurnListener(clients));
        model.addObjectiveCardListener(new PlayerObjectiveCardListener(clients));
        model.addGoldDeckListener(new GoldDeckListener(clients));
        model.addResourcedDeckListener(new ResourceDeckListener(clients));
        model.addCommonObjectiveCardListener(new CommonObjectiveCardListener(clients));
        model.addPlayerScoreListener(new PlayerScoreListener(clients));
