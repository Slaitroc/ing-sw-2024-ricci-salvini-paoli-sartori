...
public class GameTest {
    ...
    // gameModel.getCurrPlayingPlayer().getUsername() + "'s turn");
    // gameModel.getCurrPlayingPlayer().setSelectedCard(2);
    // gameModel.getCurrPlayingPlayer().play(new Point(1, 1));
    // assertNotNull(gameModel.getCurrPlayingPlayer().getPlayArea().getPlacedCards().get(new
    // Point(1, 1)));
    ...
    // while (true) {
    // for (int i = 0; i < gameModel.getNumOfPlayers(); i++) {
    // System.out.println("It's currently " + playingPlayer.getUsername() + "'s
    // turn");
    // playingPlayer.setSelectedCard(0);
    // playingPlayer.play(new Point(count, count));
    // assertNotNull(playingPlayer.getPlayArea().getPlacedCards().get(new
    // Point(count, count)));
    // System.out.println(
    // "Player: " + playingPlayer.getUsername() + " placed a card in (" + count + ",
    // " + count + ")");
    // playingPlayer.drawResource();
    // System.out.println("Player: " + playingPlayer.getUsername() + " drawn a
    // resource card\n");
    // gameModel.setNextPlayingPlayer();
    // playingPlayer = gameModel.getCurrPlayingPlayer();
    // playingPlayer.setInGameState(new NotPlaced()); // Wake up function of the
    // player
    // }
    // count++;
    ...
    // gameModel.setNextPlayingPlayer();
    // playingPlayer = gameModel.getCurrPlayingPlayer();
    // System.out.println("Player: " + playingPlayer.getUsername() + " scored a
    // total of "
